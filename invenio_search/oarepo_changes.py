...
features_incorporated = '[{"name":"importlib","base":"v3.1.0"}]'

oarepo_major_version = "13"

package_oarepo_version = "oarepo-3.1.0"

configuration = '{"name": "invenio-search", "oarepo": 13, "features": [{"name": "importlib", "base": "v3.1.0"}], "package": "invenio-search", "invenio_version": "3.1.0", "version": "3.1.0"}'
